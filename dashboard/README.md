...
동시 접속 그래프는 각 표시 구간의 최고값을 그리며, 최고점 당시의 웹 접속과 외부 에이전트 구성을 색상으로 구분합니다. 현재 접속 카드와 그래프 툴팁에서 유형별 계정 수·비율을 확인할 수 있으며, 구분 정보가 없는 과거 기록은 기타·미분류로 표시합니다. 1일·1주일·1개월은 시간별 최고, 6개월은 6시간 최고, 1년은 일별 최고입니다. 기간 평균 카드는 수집된 표본의 평균을 표시합니다.
